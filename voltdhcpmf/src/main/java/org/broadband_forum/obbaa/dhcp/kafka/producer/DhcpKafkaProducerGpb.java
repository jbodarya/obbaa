 ...
 * </p>
 */
public class DhcpKafkaProducerGpb extends AbstractDhcpKafkaProducer {

    public DhcpKafkaProducerGpb(Bundle bundle) {
        super(bundle);
    }

    private static final Logger LOGGER = Logger.getLogger(DhcpKafkaProducerGpb.class);
