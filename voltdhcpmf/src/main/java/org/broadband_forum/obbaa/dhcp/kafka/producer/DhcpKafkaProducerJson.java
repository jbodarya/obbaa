 ...
 * </p>
 */
public class DhcpKafkaProducerJson extends AbstractDhcpKafkaProducer {

    public DhcpKafkaProducerJson(Bundle bundle) {
        super(bundle);
    }

    private static final Logger LOGGER = Logger.getLogger(DhcpKafkaProducerJson.class);
